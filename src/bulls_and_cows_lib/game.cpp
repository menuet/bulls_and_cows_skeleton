...
namespace bulls_and_cows {
    ...
    void computer_plays_against_computer(const GameOptions& game_options)
    {
        ...
        {
            display_board(std::cout, game_options, board);
            std::cout << "Remaining number of possible code : " << possible_solutions.codes.size() << std::endl;
            Sleep(2000);
        ...
        {
            std::cout << "Computer did not find solution..." << std::endl;
        }
    }
    ...
    void configure_game_options(GameOptions& game_options)
    {
        ...
        do
        {
            ...
            case GameOptionsMenuChoice::ModifyMinimumAllowedCharacter:
                ...
                {
                    std::cout << "Minimum character cannot be greater than Maximum character";
                }
                else
            ...
            case GameOptionsMenuChoice::ModifyMaximumAllowedCharacter:
                ...
                {
                    std::cout << "Maximum character cannot be smaller to minimum character";
                }
                else
